...
/**
 *
 * Template Name: Blog Chess-style
...
<div class="container blog-content blog-simple <?php echo esc_attr($container_fullwidth); ?>">
	...
	<?php $paged = 1;
	$blog_postsperpage = ( function_exists('ot_get_option') && ot_get_option('blog_postsperpage') ) ? esc_html(ot_get_option('blog_postsperpage')) : get_option('posts_per_page');
	...
	if ($blog_query->have_posts()) {  ?>
		...
		<?php	while ( $blog_query->have_posts() ) : $blog_query->the_post();
			get_template_part('/templates/blog/blog', 'loop-simple');
		endwhile; ?>
